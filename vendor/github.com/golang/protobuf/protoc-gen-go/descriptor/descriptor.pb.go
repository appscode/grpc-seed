...
type FileOptions struct {
	...
	// By default Plow generators will take the proto package and CamelCase it
	// replacing '.' with underscore and use that to prefix the types/symbols
	// defined. When this options is provided, they will use this value instead
	// to prefix the types/symbols defined.
	PlowPrefix *string `protobuf:"bytes,39,opt,name=plow_prefix,json=plowPrefix" json:"plow_prefix,omitempty"`
...
func (m *FileOptions) GetPlowPrefix() string {
	if m != nil && m.PlowPrefix != nil {
		return *m.PlowPrefix
	}
	return ""
}
